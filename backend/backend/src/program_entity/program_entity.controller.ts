...
export class ProgramEntityController {
  ...
  updateSection(@Param('id') id: string, @Body() updateProgramEntityDto: any) {
  ...
  @Patch('updateremove/:id')
  updateStatus(@Param('id') id: string,  @Body() fields: any) {
    return this.programEntityService.updateStatus(+id,  fields);
  }
}
